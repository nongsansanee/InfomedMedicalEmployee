...
$sql= "SELECT a.empid,CONCAT(if(a.emprankname!='',a.emprankname,a.emprank),' ',a.empname,'  ',a.empsname) as empname,CONCAT(a.empengname,'  ',a.empengsname) as empengname FROM tbemployee a left join tbempwork b on a.empid=b.empid where a.empflag='$empflag'$cond order by CONVERT(a.empname USING tis620) ";
$db_conn = new core_mysql ();
...
?>
  <tr class="<?=$classname?>">
    ...
    <td><?=$row[2]?></td>
	<td align="center">
	  <a href="history.php?flag=2&empid=<?=$row[0]?>" target="showFrame"><img src="../image/history.gif" border="0">ประวัติ</a> 
	</td>
  </tr>
<? }?>
</table>
